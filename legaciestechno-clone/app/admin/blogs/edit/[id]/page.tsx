...
import SimpleEditor from "@/app/admin/components/SimpleEditor";
export default function EditBlogPage() {
  ...
  //     blog.id === blogId ? { ...form, id: blogId } : blog
  //   );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-300 rounded-lg p-3 text-[#191919] focus:ring-2 focus:ring-[#191919] focus:border-transparent h-24 resize-none"
            />
          </div>
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              className="flex-1 bg-[#191919] text-white px-6 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-colors"
            >
              Update Blog
            </button>
            <button
