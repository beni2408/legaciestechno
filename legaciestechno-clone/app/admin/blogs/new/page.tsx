...
export default function NewBlogPage() {
  ...
  return (
    <div>
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-[#191919] mb-2">Create New Blog</h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            <button type="submit" className="flex-1 bg-[#191919] text-white px-6 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-colors">Create Blog</button>
