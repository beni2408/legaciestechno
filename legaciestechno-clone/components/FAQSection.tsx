    ...
    <section className="py-28">
      <div className=" flex gap-20">
        ...
        <div className="w-[45%] flex flex-col justify-between">
          <div>
            <p
              className={` ${robotoMono.className} uppercase text-md tracking-widest text-[#191919] font-bold`}
            >
              FAQ
            </p>

            <h2 className={`${syne.className} text-7xl font-semibold mt-6`}>
              Common Questions
            </h2>
          </div>
          <Link href="/contact">
        ...
        <div className="w-[50%]">
          ...
          <FAQItem
            question="
How long does a typical engagement take, from discovery to delivery?"
...
"
          ...
          <FAQItem
            ...
            answer="Legacies Techno is built around the belief that technology should be engineered for the future. Unlike traditional consultancies, we emphasize scalable, adaptive solutions that integrate emerging technologies such as AI, blockchain, and zero-trust security. Our in-house innovation lab, Lynt-X Labs, keeps us ahead of the curve by experimenting with next-gen autonomous AI agents. We operate with a global delivery model, blending nearshore development in Asia with local leadership in North America, Europe, and the Middle East—providing round-the-clock momentum without sacrificing communication. Our deep regulatory expertise across sectors ensures compliance isn’t an afterthought but a built-in feature. Furthermore, our flexible commercial structures suit startups, SMBs, and large enterprises alike. From advisory-only roles to full managed service deployments, we offer complete end-to-end solutions with the mindset of an operator, not just a consultant. Your success is our mission."
          />
        </div>
      </div>
    </section>
