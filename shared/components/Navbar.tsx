    ...
    <header className="w-full bg-[#fdfbf5] text-black border-b border-black/50 lg:py-1.5">
      <nav className="lg:w-335 flex items-center justify-between py-5 px-4 lg:px-0">
        ...
        <div className="hidden lg:flex items-center gap-5 my-5">
          <ul className="flex gap-10 lg:text-[15px] tracking-wider">
            <li>
              <NavLink href="/services" className={robotoMono.className}>
                SERVICES
              </NavLink>
            </li>

            <li>
              <NavLink href="/work" className={robotoMono.className}>
                WORK
              </NavLink>
            </li>

            <li>
              <NavLink href="/studio" className={robotoMono.className}>
                STUDIO
              </NavLink>
            </li>

            <li>
              <NavLink href="/blog" className={robotoMono.className}>
                BLOG
              </NavLink>
            </li>

            <li>
              <NavLink href="/lynt-x-labs" className={robotoMono.className}>
                LYNT-X LABS
              </NavLink>
            </li>
          </ul>
...
function NavLink({ href, children, className }: any) {
  return (
    <Link
      href={href}
